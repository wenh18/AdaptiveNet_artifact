...
oncloud.load_to_multimodel('weights/segmentation/multiclass.pth', model, part='head')
oncloud.load_to_multimodel('weights/segmentation/multiclassresnet_0epoch30.pth', model, part='backbone')
